...
abstract class AbstractTest extends TestCase
{
    ...
    {
        $config = \Marktic\Phpqa\Tests\config();
    ...
    {
        $config = require \Marktic\Phpqa\Tests\TEST_FIXTURE_PATH . '/config/' . $name . '.php';
        $this->loadConfig($config);
    }

    protected function loadServiceProvider(): FaqServiceProvider
    {
        $container = Container::container();
        $provider = new FaqServiceProvider();
